...
```{r psacoin_all_figures, cache=TRUE, dependson=c("psacoin_plot_sensitivity", "plot_psacoin_dynamics", "psacoin_uncertain"), fig.height=3.2, fig.width=5.5}
...
```{r water_plots, cache=TRUE, dependson="water_arrange_sensitivities", fig.height=5.9, fig.width=5.5}
